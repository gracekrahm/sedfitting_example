...
def build_model(zred, argv_alpha, **kwargs):
    ...
    tuniv = cosmo.age(zred).value #Gyr
    nbins=10
    ...
    ncomp = nbins
    alpha_sfh = argv_alpha  # desired Dirichlet concentration                                                                                                                            
...
#load jwst below
filternames = (hst_wfc3_uv+hst_wfc3_ir+jwst_nircam + jwst_miri + galex + spitzer_mips + herschel_pacs + herschel_spire)
